...
{
    internal class Day8Task1 : AdventOfCodeBaseTask<Day8Map>
    {
        ...
        protected void CalculateAntinodes(Day8Item item1, Day8Item item2, bool[,] antinodeMap)
        {
            ...
            if (firstAntinode.X >= 0 && firstAntinode.X < antinodeMap.GetLength(0) && firstAntinode.Y >= 0 && firstAntinode.Y < antinodeMap.GetLength(1))
            {
                antinodeMap[firstAntinode.X, firstAntinode.Y] = true;
                //Console.WriteLine($"Antinode {firstAntinode.X},{firstAntinode.Y}");
            }

            if (secondAntinode.X >= 0 && secondAntinode.X < antinodeMap.GetLength(0) && secondAntinode.Y >= 0 && secondAntinode.Y < antinodeMap.GetLength(1))
            {
    ...
    internal class Day8Map
    {
        public Day8Item[][] Items { get; set; }
    }

    internal class Day8Item
    {
